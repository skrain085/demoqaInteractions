package com.demoqaInteractions.Dragable;
...
public class Dragable_Simple_Example {
...
WebDriver driver;
	...
	public void FunctionMethod() {
		try {
			...
			WebElement dragMe = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='dragBox']")));
